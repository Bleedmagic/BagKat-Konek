...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['cancel_request'])) {
    ...
    $cancel_sql = "UPDATE barangay_certificate SET status = 'Cancelled' WHERE id = $request_id";

    if ($conn->query($cancel_sql) === TRUE) {
        echo "<script>alert('Request cancelled successfully'); window.location.href = 'res_certificate_req.php';</script>";
        exit();
    } else {
...
<head>
    ...
    <title>Certificate Request / BagKat</title>
    <link rel="stylesheet" href="../css/res_certificate_req.css">
</head>
...
<body>
    ...
    <main class="container">
        <div class="request-list">
            <h2>REQUEST STATUS: BARANGAY CERTIFICATE</h2>
