...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['cancel_request'])) {
    ...
    $cancel_sql = "UPDATE barangay_indigency SET status = 'Cancelled' WHERE id = $request_id";

    if ($conn->query($cancel_sql) === TRUE) {
        echo "<script>alert('Request cancelled successfully'); window.location.href = 'res_indigency_req.php';</script>";
        exit();
    } else {
...
<head>
    ...
    <title>Indigency Request / BagKat</title>
    <link rel="stylesheet" href="../css/res_indigency_req.css">
</head>
...
<body>
    ...
    <main class="container">
        <div class="request-list">
            <h2>REQUEST STATUS: BARANGAY INDIGENCY</h2>
